...
var _shohamh$learnmath_frontend$Page_Login$dataToUser = F2(
	function (model, responseData) {
		return A3(
			_shohamh$learnmath_frontend$Data_User$User,
			'email@email.com',
			responseData.authToken,
			_shohamh$learnmath_frontend$Data_User$Username(model.username));
	});
...
var _shohamh$learnmath_frontend$Page_Login$ResponseData = F3(
	function (a, b, c) {
		return {success: a, authToken: b, error_messages: c};
	});
...
var _shohamh$learnmath_frontend$Page_Login$send = function (requestData) {
	...
	var url = A2(_elm_lang$core$Basics_ops['++'], _shohamh$learnmath_frontend$Config$server, '/login');
...
var _shohamh$learnmath_frontend$Page_Register$send = function (requestData) {
	...
	var url = A2(_elm_lang$core$Basics_ops['++'], _shohamh$learnmath_frontend$Config$server, '/register');
...
var _shohamh$learnmath_frontend$Page_Register$viewForm = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onSubmit(_shohamh$learnmath_frontend$Page_Register$Submit),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
