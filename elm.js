...
var _shohamh$learnmath_frontend$Config$server = A2(
	_elm_lang$core$Basics_ops['++'],
	_shohamh$learnmath_frontend$Config$protocol,
	A2(
		_elm_lang$core$Basics_ops['++'],
		'://',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_shohamh$learnmath_frontend$Config$serverAddress,
			A2(_elm_lang$core$Basics_ops['++'], ':', _shohamh$learnmath_frontend$Config$serverPort))));
var _shohamh$learnmath_frontend$Config$apiUrl = function (path) {
	return A2(_elm_lang$core$Basics_ops['++'], _shohamh$learnmath_frontend$Config$server, path);
};

var _shohamh$learnmath_frontend$Data_AuthToken$withAuthorization = F2(
...
var _shohamh$learnmath_frontend$Data_AuthToken$encode = function (_p1) {
	var _p2 = _p1;
	return _elm_lang$core$Json_Encode$string(_p2._0);
};
var _shohamh$learnmath_frontend$Data_AuthToken$toString = function (_p3) {
	var _p4 = _p3;
	return _p4._0;
};
var _shohamh$learnmath_frontend$Data_AuthToken$AuthToken = function (a) {
...
var _shohamh$learnmath_frontend$Data_User$roleToString = function (role) {
	var _p0 = role;
	if (_p0.ctor === 'Student') {
		return 'Student';
	} else {
...
var _shohamh$learnmath_frontend$Data_User$usernameToHtml = function (_p1) {
	var _p2 = _p1;
	return _elm_lang$html$Html$text(_p2._0);
};
var _shohamh$learnmath_frontend$Data_User$encodeUsername = function (_p3) {
	var _p4 = _p3;
	return _elm_lang$core$Json_Encode$string(_p4._0);
};
var _shohamh$learnmath_frontend$Data_User$usernameToString = function (_p5) {
	var _p6 = _p5;
	return _p6._0;
};
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'role',
							_1: _shohamh$learnmath_frontend$Data_User$roleEncoder(user.role)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _shohamh$learnmath_frontend$Data_User$User = F4(
	function (a, b, c, d) {
		return {email: a, token: b, username: c, role: d};
	});
		...
		switch (_p8) {
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown role: ', _p8));
		}
	},
	_elm_lang$core$Json_Decode$string);
...
var _shohamh$learnmath_frontend$Data_User$usernameParser = A2(
	...
	function (_p9) {
		return _elm_lang$core$Result$Ok(
			_shohamh$learnmath_frontend$Data_User$Username(_p9));
	});
...
var _shohamh$learnmath_frontend$Data_User$decoder = A3(
	...
	'role',
	_shohamh$learnmath_frontend$Data_User$roleDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'username',
...
var _shohamh$learnmath_frontend$Util$httpErrorToString = function (httpError) {
	var _p0 = httpError;
	switch (_p0.ctor) {
		case 'BadUrl':
		...
		default:
			return A2(_elm_lang$core$Basics_ops['++'], 'JSON decoding of response failed: ', _p0._0);
	}
};
var _shohamh$learnmath_frontend$Util$httpPost = F5(
	function (endpoint, payload, payloadEncoder, responseDecoder, responseMsg) {
		...
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			_shohamh$learnmath_frontend$Config$server,
			A2(_elm_lang$core$Basics_ops['++'], '/', endpoint));
		var request = A3(_elm_lang$http$Http$post, url, body, responseDecoder);
		return A2(_elm_lang$http$Http$send, responseMsg, request);
	});
var _shohamh$learnmath_frontend$Util$appendErrors = F2(
...
var _shohamh$learnmath_frontend$Util$onClickStopPropagation = function (msg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
		_elm_lang$core$Native_Utils.update(
...
var _shohamh$learnmath_frontend$Util$viewIf = F2(
	function (condition, content) {
		return condition ? content : _elm_lang$html$Html$text('');
	});
var _shohamh$learnmath_frontend$Util_ops = _shohamh$learnmath_frontend$Util_ops || {};
_shohamh$learnmath_frontend$Util_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _shohamh$learnmath_frontend$Util$pair = F2(
...
var _shohamh$learnmath_frontend$Data_Session$getSid = function (session) {
	var _p1 = session.user;
	if (_p1.ctor === 'Just') {
		return _shohamh$learnmath_frontend$Data_AuthToken$toString(_p1._0.token);
	} else {
		return '';
	}
};
var _shohamh$learnmath_frontend$Data_Session$Session = function (a) {
	return {user: a};
};

var _shohamh$learnmath_frontend$Page_AddQuestion$onExport = function (message) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'exports-changed',
		A2(
...
var _shohamh$learnmath_frontend$Page_AddQuestion$subs = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _shohamh$learnmath_frontend$Page_AddQuestion$viewErrorMessages = function (errorMessages) {
	return A2(
...
var _shohamh$learnmath_frontend$Page_AddQuestion$loadCurriculumsAndSubjectsEncoder = function (sid) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'sid',
				_1: _elm_lang$core$Json_Encode$string(sid)
			},
			_1: {ctor: '[]'}
		});
};
var _shohamh$learnmath_frontend$Page_AddQuestion$questionEncoder = function (question) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _shohamh$learnmath_frontend$Page_AddQuestion$model = {
	successMessage: '',
	errorMessages: {ctor: '[]'},
	lastExport: '',
	curriculums: {ctor: '[]'},
	selectedCurriculum: '',
	selectedSubjects: {ctor: '[]'},
	subjectsInCurriculums: _elm_lang$core$Dict$empty
};
var _shohamh$learnmath_frontend$Page_AddQuestion$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {successMessage: a, errorMessages: b, lastExport: c, curriculums: d, selectedCurriculum: e, selectedSubjects: f, subjectsInCurriculums: g};
	});
var _shohamh$learnmath_frontend$Page_AddQuestion$Question = function (a) {
	return {mathml: a};
};
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				...
				_1: _shohamh$learnmath_frontend$Page_AddQuestion$questionEncoder(
					_shohamh$learnmath_frontend$Page_AddQuestion$questionFromModel(_p3))
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: function () {
						var _p2 = _p1._0.user;
						if (_p2.ctor === 'Just') {
							return _shohamh$learnmath_frontend$Data_AuthToken$encode(_p2._0.token);
						} else {
				...
				_1: {
					...
					_0: {
						...
						_0: 'subjects',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p3.selectedSubjects))
					},
					_1: {ctor: '[]'}
				}
			}
...
var _shohamh$learnmath_frontend$Page_AddQuestion$ResponseData = F2(
	function (a, b) {
		return {success: a, error_messages: b};
	});
var _shohamh$learnmath_frontend$Page_AddQuestion$responseDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'error_messages',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
	A3(
		...
		'success',
		_elm_lang$core$Json_Decode$bool,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_shohamh$learnmath_frontend$Page_AddQuestion$ResponseData)));
var _shohamh$learnmath_frontend$Page_AddQuestion$SubjectsInCurriculums = F3(
	function (a, b, c) {
		return {subjectsInCurriculums: a, success: b, error_messages: c};
	});
var _shohamh$learnmath_frontend$Page_AddQuestion$loadCursAndSubjectsRespDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'error_messages',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
	A3(
		...
		A3(
			...
			_elm_lang$core$Json_Decode$dict(
				_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)),
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_shohamh$learnmath_frontend$Page_AddQuestion$SubjectsInCurriculums))));
var _shohamh$learnmath_frontend$Page_AddQuestion$LoadSubjectsInCurriculums = function (a) {
	return {ctor: 'LoadSubjectsInCurriculums', _0: a};
};
var _shohamh$learnmath_frontend$Page_AddQuestion$loadCurriculumsAndSubjects = F2(
	function (session, model) {
		var sid = function () {
			var _p4 = session.user;
			if (_p4.ctor === 'Just') {
				return _shohamh$learnmath_frontend$Data_AuthToken$toString(_p4._0.token);
			} else {
				return '';
			}
		}();
		return A5(_shohamh$learnmath_frontend$Util$httpPost, 'subjects_in_all_curriculums', sid, _shohamh$learnmath_frontend$Page_AddQuestion$loadCurriculumsAndSubjectsEncoder, _shohamh$learnmath_frontend$Page_AddQuestion$loadCursAndSubjectsRespDecoder, _shohamh$learnmath_frontend$Page_AddQuestion$LoadSubjectsInCurriculums);
	});
var _shohamh$learnmath_frontend$Page_AddQuestion$AddQuestionResult = function (a) {
	return {ctor: 'AddQuestionResult', _0: a};
};
var _shohamh$learnmath_frontend$Page_AddQuestion$addQuestion = F2(
	function (session, model) {
		return A5(
...
var _shohamh$learnmath_frontend$Page_AddQuestion$update = F3(
	function (session, msg, model) {
		...
		switch (_p5.ctor) {
			case 'MyScriptExport':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							lastExport: A2(_elm_lang$core$Debug$log, 'latestExport', _p5._0)
						}),
					{ctor: '[]'});
			...
			case 'AddQuestionResult':
				if (_p5._0.ctor === 'Err') {
					var errorMessage = function () {
						var _p6 = _p5._0._0;
						switch (_p6.ctor) {
							case 'BadUrl':
								return A2(_elm_lang$core$Basics_ops['++'], 'Bad url: ', _p6._0);
							case 'Timeout':
								return 'Request timed out.';
							case 'NetworkError':
								return 'Network error (no connectivity).';
							case 'BadStatus':
								return A2(
									_elm_lang$core$Basics_ops['++'],
									'Bad status code returned: ',
									_elm_lang$core$Basics$toString(_p6._0.status.code));
							default:
								return A2(_elm_lang$core$Basics_ops['++'], 'JSON decoding of response failed: ', _p6._0);
						}
					}();
					return A2(
						_shohamh$learnmath_frontend$Util_ops['=>'],
					...
					var newModel = model;
					return A2(_shohamh$learnmath_frontend$Util_ops['=>'], newModel, _elm_lang$core$Platform_Cmd$none);
				}
			default:
				if (_p5._0.ctor === 'Ok') {
					var _p7 = _p5._0._0;
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								curriculums: _elm_lang$core$Dict$keys(_p7.subjectsInCurriculums),
								subjectsInCurriculums: _p7.subjectsInCurriculums
							}),
						{ctor: '[]'});
				} else {
					var errorMessage = function () {
						...
						switch (_p8.ctor) {
							case 'BadUrl':
								return A2(_elm_lang$core$Basics_ops['++'], 'Bad url: ', _p8._0);
							case 'Timeout':
								return 'Request timed out.';
							case 'NetworkError':
								return 'Network error (no connectivity).';
							case 'BadStatus':
								return A2(
									_elm_lang$core$Basics_ops['++'],
									'Bad status code returned: ',
									_elm_lang$core$Basics$toString(_p8._0.status.code));
							default:
								return A2(_elm_lang$core$Basics_ops['++'], 'JSON decoding of response failed: ', _p8._0);
						}
					}();
					return A2(
						_shohamh$learnmath_frontend$Util_ops['=>'],
...
var _shohamh$learnmath_frontend$Page_AddQuestion$AddQuestion = {ctor: 'AddQuestion'};
var _shohamh$learnmath_frontend$Page_AddQuestion$SelectSubjects = function (a) {
	return {ctor: 'SelectSubjects', _0: a};
};
var _shohamh$learnmath_frontend$Page_AddQuestion$SelectCurriculum = function (a) {
	return {ctor: 'SelectCurriculum', _0: a};
};
var _shohamh$learnmath_frontend$Page_AddQuestion$MyScriptExport = function (a) {
	return {ctor: 'MyScriptExport', _0: a};
};
var _shohamh$learnmath_frontend$Page_AddQuestion$view = F2(
	function (session, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('add-question-page'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Curriculum:'),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$select,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_shohamh$learnmath_frontend$Page_AddQuestion$SelectCurriculum),
											_1: {ctor: '[]'}
										},
										A2(
											_elm_lang$core$List$map,
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('Pick subjects (Hold Ctrl to select multiple subjects) this question fits in:'),
										_1: {
											ctor: '::',
											_0: function () {
												var items = function () {
													var _p9 = A2(_elm_lang$core$Dict$get, model.selectedCurriculum, model.subjectsInCurriculums);
													if (_p9.ctor === 'Just') {
														return _p9._0;
													} else {
														return {ctor: '[]'};
												...
												return A3(
													...
													A2(
														_abadi199$elm_input_extra$MultiSelect$Options,
														A2(
															_elm_lang$core$List$map,
															function (x) {
																return A3(_abadi199$elm_input_extra$MultiSelect$Item, x, x, true);
															},
															items),
														_shohamh$learnmath_frontend$Page_AddQuestion$SelectSubjects),
													{ctor: '[]'},
									...
									_0: A2(
										...
										},
										{
											...
											_0: function () {
												...
												var mimetypesEncoded = A2(
													_elm_lang$core$Json_Encode$encode,
													0,
													_elm_lang$core$Json_Encode$list(
														A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, mimetypes)));
												return A3(
													...
													'myscript-math-web',
													{
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _shohamh$learnmath_frontend$Page_AddQuestion$onExport(_shohamh$learnmath_frontend$Page_AddQuestion$MyScriptExport),
																	_1: {
																		ctor: '::',
											...
											_1: {
												ctor: '::',
												_0: _shohamh$learnmath_frontend$Page_AddQuestion$viewErrorMessages(model.errorMessages),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$button,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_shohamh$learnmath_frontend$Page_AddQuestion$AddQuestion),
																_1: {ctor: '[]'}
															}
														},
														{
		...
		switch (_p0.ctor) {
			...
			case 'Dashboard':
				return {
					...
					_1: {
						ctor: '::',
						_0: _shohamh$learnmath_frontend$Data_User$usernameToString(_p0._0),
						_1: {ctor: '[]'}
					}
				};
			default:
...
var _shohamh$learnmath_frontend$Route$href = function (route) {
	return _elm_lang$html$Html_Attributes$href(
		_shohamh$learnmath_frontend$Route$routeToString(route));
};
var _shohamh$learnmath_frontend$Route$modifyUrl = function (_p1) {
	return _elm_lang$navigation$Navigation$modifyUrl(
		_shohamh$learnmath_frontend$Route$routeToString(_p1));
};
var _shohamh$learnmath_frontend$Route$TeacherDashboard = {ctor: 'TeacherDashboard'};
var _shohamh$learnmath_frontend$Route$Dashboard = function (a) {
	return {ctor: 'Dashboard', _0: a};
};
var _shohamh$learnmath_frontend$Route$AddQuestion = {ctor: 'AddQuestion'};
var _shohamh$learnmath_frontend$Route$Question = {ctor: 'Question'};
var _shohamh$learnmath_frontend$Route$Register = {ctor: 'Register'};
var _shohamh$learnmath_frontend$Route$Logout = {ctor: 'Logout'};
var _shohamh$learnmath_frontend$Route$Login = {ctor: 'Login'};
var _shohamh$learnmath_frontend$Route$Home = {ctor: 'Home'};
var _shohamh$learnmath_frontend$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_evancz$url_parser$UrlParser$map,
			_shohamh$learnmath_frontend$Route$Home,
			_evancz$url_parser$UrlParser$s('')),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_shohamh$learnmath_frontend$Route$Login,
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_shohamh$learnmath_frontend$Route$Register,
					...
					_1: {
						...
						_0: A2(
							...
							_evancz$url_parser$UrlParser$s('question')),
						_1: {
							ctor: '::',
							_0: A2(
								_evancz$url_parser$UrlParser$map,
								_shohamh$learnmath_frontend$Route$AddQuestion,
								_evancz$url_parser$UrlParser$s('add_question')),
							_1: {
								ctor: '::',
								_0: A2(
									_evancz$url_parser$UrlParser$map,
									_shohamh$learnmath_frontend$Route$Dashboard,
									A2(
										_evancz$url_parser$UrlParser_ops['</>'],
										_evancz$url_parser$UrlParser$s('dashboard'),
										_shohamh$learnmath_frontend$Data_User$usernameParser)),
								_1: {
									ctor: '::',
									_0: A2(
										_evancz$url_parser$UrlParser$map,
										_shohamh$learnmath_frontend$Route$TeacherDashboard,
										_evancz$url_parser$UrlParser$s('teacher_dashboard')),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _shohamh$learnmath_frontend$Route$fromLocation = function (location) {
	return _elm_lang$core$String$isEmpty(location.hash) ? _elm_lang$core$Maybe$Just(_shohamh$learnmath_frontend$Route$Home) : A2(_evancz$url_parser$UrlParser$parseHash, _shohamh$learnmath_frontend$Route$route, location);
};

var _shohamh$learnmath_frontend$Views_Spinner$spinner = A2(
	_elm_lang$html$Html$li,
	{
		...
		_1: {
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_shohamh$learnmath_frontend$Util_ops['=>'], 'float', 'left'),
					_1: {
						ctor: '::',
						_0: A2(_shohamh$learnmath_frontend$Util_ops['=>'], 'margin', '8px'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _shohamh$learnmath_frontend$Views_Page$bodyId = 'page-body';
var _shohamh$learnmath_frontend$Views_Page$navbarLink = F3(
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							ctor: '::',
							_0: _shohamh$learnmath_frontend$Route$href(route),
							_1: {ctor: '[]'}
						}
					},
					linkContent),
...
var _shohamh$learnmath_frontend$Views_Page$viewFooter = A2(
...
var _shohamh$learnmath_frontend$Views_Page$TeacherDashboard = {ctor: 'TeacherDashboard'};
var _shohamh$learnmath_frontend$Views_Page$Dashboard = function (a) {
	return {ctor: 'Dashboard', _0: a};
};
var _shohamh$learnmath_frontend$Views_Page$AddQuestion = {ctor: 'AddQuestion'};
...
var _shohamh$learnmath_frontend$Views_Page$viewSignIn = F2(
		...
		if (_p0.ctor === 'Nothing') {
			return {
				...
				_0: A3(
					...
					_elm_lang$core$Native_Utils.eq(page, _shohamh$learnmath_frontend$Views_Page$Login),
					_shohamh$learnmath_frontend$Route$Login,
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A3(
						_shohamh$learnmath_frontend$Views_Page$navbarLink,
						_elm_lang$core$Native_Utils.eq(page, _shohamh$learnmath_frontend$Views_Page$Register),
						_shohamh$learnmath_frontend$Route$Register,
						{
							ctor: '::',
			...
			if (_p1.ctor === 'Student') {
				return {
					...
					_0: A3(
						...
						_elm_lang$core$Native_Utils.eq(
							page,
							_shohamh$learnmath_frontend$Views_Page$Dashboard(_p2.username)),
						_shohamh$learnmath_frontend$Route$Dashboard(_p2.username),
						{
							ctor: '::',
				...
				return {
					...
					_0: A3(
						_shohamh$learnmath_frontend$Views_Page$navbarLink,
						_elm_lang$core$Native_Utils.eq(page, _shohamh$learnmath_frontend$Views_Page$TeacherDashboard),
						_shohamh$learnmath_frontend$Route$TeacherDashboard,
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Dashboard'),
					...
					_1: {
						...
						_0: A3(
							_shohamh$learnmath_frontend$Views_Page$navbarLink,
							_elm_lang$core$Native_Utils.eq(page, _shohamh$learnmath_frontend$Views_Page$AddQuestion),
							_shohamh$learnmath_frontend$Route$AddQuestion,
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Add Question'),
...
var _shohamh$learnmath_frontend$Views_Page$Home = {ctor: 'Home'};
var _shohamh$learnmath_frontend$Views_Page$viewHeader = F3(
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$a,
							{
								...
								_1: {
									ctor: '::',
									_0: _shohamh$learnmath_frontend$Route$href(_shohamh$learnmath_frontend$Route$Home),
									_1: {ctor: '[]'}
								}
							},
							{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A3(_elm_lang$html$Html_Lazy$lazy2, _shohamh$learnmath_frontend$Util$viewIf, isLoading, _shohamh$learnmath_frontend$Views_Spinner$spinner),
									_1: {
										ctor: '::',
										_0: A3(
											_shohamh$learnmath_frontend$Views_Page$navbarLink,
											_elm_lang$core$Native_Utils.eq(page, _shohamh$learnmath_frontend$Views_Page$Home),
											_shohamh$learnmath_frontend$Route$Home,
											{
												ctor: '::',
										...
										_1: A2(_shohamh$learnmath_frontend$Views_Page$viewSignIn, page, user)
									}
								}),
							_1: {ctor: '[]'}
						}
...
var _shohamh$learnmath_frontend$Views_Page$frame = F4(
	function (isLoading, user, page, content) {
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_shohamh$learnmath_frontend$Views_Page$viewHeader, page, user, isLoading),
				_1: {
					ctor: '::',
					_0: content,
					_1: {
						ctor: '::',
						_0: _shohamh$learnmath_frontend$Views_Page$viewFooter,
						_1: {ctor: '[]'}
					}
				}
			});
...
var _shohamh$learnmath_frontend$Page_Errored$Model = F2(
	function (a, b) {
		return {activePage: a, errorMessage: b};
	});
var _shohamh$learnmath_frontend$Page_Errored$PageLoadError = function (a) {
	return {ctor: 'PageLoadError', _0: a};
};
var _shohamh$learnmath_frontend$Page_Errored$pageLoadError = F2(
	function (activePage, errorMessage) {
		return _shohamh$learnmath_frontend$Page_Errored$PageLoadError(
			{activePage: activePage, errorMessage: errorMessage});
	});

var _shohamh$learnmath_frontend$Page_Home$update = F3(
	function (session, msg, model) {
		var _p0 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _shohamh$learnmath_frontend$Page_Home$view = F2(
	function (session, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _shohamh$learnmath_frontend$Views_Form$viewErrors = function (errors) {
	return A2(
		_elm_lang$html$Html$ul,
		{
			ctor: '::',
...
var _shohamh$learnmath_frontend$Views_Form$password = function (attrs) {
	return A2(
		_shohamh$learnmath_frontend$Views_Form$control,
		_elm_lang$html$Html$input,
		A2(
...
var _shohamh$learnmath_frontend$Page_Login$viewErrorMessages = function (errorMessages) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
...
var _shohamh$learnmath_frontend$Page_Login$requestEncoder = function (requestData) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _shohamh$learnmath_frontend$Page_Login$model = {
	username: '',
	password: '',
	successMessage: '',
	errorMessages: {ctor: '[]'}
};
var _shohamh$learnmath_frontend$Page_Login$storeSession = function (user) {
	return _shohamh$learnmath_frontend$Ports$storeSession(
		_elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Json_Encode$encode,
				0,
				_shohamh$learnmath_frontend$Data_User$encode(user))));
};
var _shohamh$learnmath_frontend$Page_Login$Model = F4(
	function (a, b, c, d) {
		return {username: a, password: b, successMessage: c, errorMessages: d};
	});
var _shohamh$learnmath_frontend$Page_Login$RequestData = F2(
	function (a, b) {
		return {username: a, password: b};
	});
var _shohamh$learnmath_frontend$Page_Login$requestModel = function (model) {
	return A2(_shohamh$learnmath_frontend$Page_Login$RequestData, model.username, model.password);
};
var _shohamh$learnmath_frontend$Page_Login$ResponseData = F3(
	function (a, b, c) {
		return {success: a, user: b, error_messages: c};
	});
var _shohamh$learnmath_frontend$Page_Login$responseDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'error_messages',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'user',
		_shohamh$learnmath_frontend$Data_User$decoder,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'success',
			_elm_lang$core$Json_Decode$bool,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_shohamh$learnmath_frontend$Page_Login$ResponseData))));
var _shohamh$learnmath_frontend$Page_Login$SubmitResult = function (a) {
	return {ctor: 'SubmitResult', _0: a};
};
var _shohamh$learnmath_frontend$Page_Login$Submit = {ctor: 'Submit'};
var _shohamh$learnmath_frontend$Page_Login$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _shohamh$learnmath_frontend$Page_Login$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _shohamh$learnmath_frontend$Page_Login$viewForm = A2(
	_elm_lang$html$Html$form,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onSubmit(_shohamh$learnmath_frontend$Page_Login$Submit),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			_shohamh$learnmath_frontend$Views_Form$input,
			{
				ctor: '::',
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_shohamh$learnmath_frontend$Page_Login$SetUsername),
						_1: {ctor: '[]'}
					}
				}
			},
		...
		_1: {
			ctor: '::',
			_0: A2(
				_shohamh$learnmath_frontend$Views_Form$password,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('form-control-lg'),
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_shohamh$learnmath_frontend$Page_Login$SetPassword),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _shohamh$learnmath_frontend$Page_Login$view = F2(
	function (session, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
								...
								_0: A2(
									...
									},
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _shohamh$learnmath_frontend$Page_Login$viewForm,
												_1: {
													ctor: '::',
													_0: _shohamh$learnmath_frontend$Page_Login$viewErrorMessages(model.errorMessages),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _shohamh$learnmath_frontend$Page_Login$SetUser = function (a) {
	return {ctor: 'SetUser', _0: a};
};
var _shohamh$learnmath_frontend$Page_Login$NoOp = {ctor: 'NoOp'};
var _shohamh$learnmath_frontend$Page_Login$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SetUsername':
				...
				return A2(
					...
					A2(
						...
						A5(
							_shohamh$learnmath_frontend$Util$httpPost,
							'login',
							_shohamh$learnmath_frontend$Page_Login$requestModel(model),
							_shohamh$learnmath_frontend$Page_Login$requestEncoder,
							_shohamh$learnmath_frontend$Page_Login$responseDecoder,
							_shohamh$learnmath_frontend$Page_Login$SubmitResult)),
					_shohamh$learnmath_frontend$Page_Login$NoOp);
			default:
				if (_p0._0.ctor === 'Ok') {
					var _p1 = _p0._0._0;
...
var _shohamh$learnmath_frontend$Views_Assets$src = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$html$Html_Attributes$src(_p1._0);
};
var _shohamh$learnmath_frontend$Views_Assets$Image = function (a) {
	return {ctor: 'Image', _0: a};
};
var _shohamh$learnmath_frontend$Views_Assets$error = _shohamh$learnmath_frontend$Views_Assets$Image('https://www.packagor.com/wp-content/uploads/2017/03/404-error-not-found.jpg');

var _shohamh$learnmath_frontend$Page_NotFound$view = function (session) {
	return A2(
		_elm_lang$html$Html$main_,
		{
			ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _shohamh$learnmath_frontend$Views_Assets$src(_shohamh$learnmath_frontend$Views_Assets$error),
								_1: {
									ctor: '::',
...
var _shohamh$learnmath_frontend$Page_Question$onExport = function (message) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'exports-changed',
		A2(
...
var _shohamh$learnmath_frontend$Page_Question$subs = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _shohamh$learnmath_frontend$Page_Question$viewErrorMessages = function (errorMessages) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
...
var _shohamh$learnmath_frontend$Page_Question$checkSolutionEncoder = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1._1;
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				...
				_1: _elm_lang$core$Json_Encode$string(
					_shohamh$learnmath_frontend$Data_Session$getSid(_p1._0))
			},
			_1: {
				ctor: '::',
				_0: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'solutions',
						_1: _elm_lang$core$Json_Encode$string(_p2.lastExport)
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_0: 'subjects',
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p2.subjects))
						},
						_1: {ctor: '[]'}
					}
				}
...
var _shohamh$learnmath_frontend$Page_Question$loadQuestionEncoder = function (sid) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _shohamh$learnmath_frontend$Page_Question$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {successMessage: a, errorMessages: b, lastExport: c, exportCount: d, lastConvert: e, convertCount: f, question: g, subjects: h, isCorrect: i};
	});
var _shohamh$learnmath_frontend$Page_Question$LoadQuestionResponseData = F4(
	function (a, b, c, d) {
		return {success: a, error_messages: b, problem: c, subjects: d};
	});
...
var _shohamh$learnmath_frontend$Page_Question$checkSolution = F2(
	function (session, model) {
		return A5(
			...
			'check_solution',
			{ctor: '_Tuple2', _0: session, _1: model},
			_shohamh$learnmath_frontend$Page_Question$checkSolutionEncoder,
	...
	function (session, msg, model) {
		...
		switch (_p3.ctor) {
			...
			case 'MyScriptConvert':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							lastConvert: A2(_elm_lang$core$Debug$log, 'latestConvert', _p3._0),
			...
			case 'CheckSolutionResult':
				if (_p3._0.ctor === 'Err') {
					var errorMessage = _shohamh$learnmath_frontend$Util$httpErrorToString(_p3._0._0);
					return A2(
						_shohamh$learnmath_frontend$Util_ops['=>'],
						_elm_lang$core$Native_Utils.update(
							model,
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								isCorrect: _elm_lang$core$Maybe$Just(_p4.correct),
								errorMessages: _p4.error_messages
							}),
						_elm_lang$core$Platform_Cmd$none);
				}
			default:
				if (_p3._0.ctor === 'Err') {
					...
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{question: _p5.problem, subjects: _p5.subjects});
					return A2(
						_shohamh$learnmath_frontend$Util_ops['=>'],
						newModel,
...
var _shohamh$learnmath_frontend$Page_Question$loadQuestion = F2(
	function (session, model) {
		return A5(
			_shohamh$learnmath_frontend$Util$httpPost,
			'question',
			_shohamh$learnmath_frontend$Data_Session$getSid(session),
			_shohamh$learnmath_frontend$Page_Question$loadQuestionEncoder,
...
var _shohamh$learnmath_frontend$Page_Question$MyScriptConvert = function (a) {
	return {ctor: 'MyScriptConvert', _0: a};
};
...
var _shohamh$learnmath_frontend$Page_Question$view = F2(
	function (session, model) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('question-page'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Question subjects:'),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$ul,
...
var _shohamh$learnmath_frontend$Page_Register$viewErrorMessages = function (errorMessages) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
...
var _shohamh$learnmath_frontend$Page_Register$requestEncoder = function (requestData) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _shohamh$learnmath_frontend$Page_Register$model = {
	username: '',
	password: '',
	passwordAgain: '',
	email: '',
...
var _shohamh$learnmath_frontend$Page_Register$responseDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'error_messages',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
	A3(
		...
		'success',
		_elm_lang$core$Json_Decode$bool,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_shohamh$learnmath_frontend$Page_Register$ResponseData)));
var _shohamh$learnmath_frontend$Page_Register$RegisterResult = function (a) {
...
var _shohamh$learnmath_frontend$Page_Register$SetPasswordAgain = function (a) {
	return {ctor: 'SetPasswordAgain', _0: a};
};
var _shohamh$learnmath_frontend$Page_Register$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _shohamh$learnmath_frontend$Page_Register$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _shohamh$learnmath_frontend$Page_Register$viewForm = A2(
	_elm_lang$html$Html$form,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onSubmit(_shohamh$learnmath_frontend$Page_Register$Register),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			_shohamh$learnmath_frontend$Views_Form$input,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_shohamh$learnmath_frontend$Page_Register$SetUsername),
						_1: {ctor: '[]'}
					}
				}
			},
			...
			_0: A2(
				_shohamh$learnmath_frontend$Views_Form$input,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_shohamh$learnmath_frontend$Page_Register$SetEmail),
							_1: {ctor: '[]'}
						}
					}
				},
				...
				_0: A2(
					_shohamh$learnmath_frontend$Views_Form$password,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_shohamh$learnmath_frontend$Page_Register$SetPassword),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _shohamh$learnmath_frontend$Page_Register$view = F2(
	function (session, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
								...
								_0: A2(
									...
									},
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _shohamh$learnmath_frontend$Page_Register$viewForm,
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$div,
													...
													_1: {
														ctor: '::',
														_0: _shohamh$learnmath_frontend$Page_Register$viewErrorMessages(model.errorMessages),
														_1: {ctor: '[]'}
													}
												}
											}
...
var _shohamh$learnmath_frontend$Page_Register$SetUser = function (a) {
	return {ctor: 'SetUser', _0: a};
};
var _shohamh$learnmath_frontend$Page_Register$NoOp = {ctor: 'NoOp'};
var _shohamh$learnmath_frontend$Page_Register$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SetUsername':
				...
				return A2(
					...
					A2(
						...
						A5(
							_shohamh$learnmath_frontend$Util$httpPost,
							'register',
							_shohamh$learnmath_frontend$Page_Register$requestModel(model),
							_shohamh$learnmath_frontend$Page_Register$requestEncoder,
							_shohamh$learnmath_frontend$Page_Register$responseDecoder,
							_shohamh$learnmath_frontend$Page_Register$RegisterResult)),
					_shohamh$learnmath_frontend$Page_Register$NoOp);
			default:
				if (_p0._0.ctor === 'Ok') {
					var _p2 = _p0._0._0;
...
var _shohamh$learnmath_frontend$Page_TeacherDashboard$update = F3(
	function (session, msg, model) {
		var _p0 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _shohamh$learnmath_frontend$Page_TeacherDashboard$view = F2(
	function (session, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _shohamh$learnmath_frontend$Page_TeacherDashboard$model = {};
var _shohamh$learnmath_frontend$Page_TeacherDashboard$Model = {};
var _shohamh$learnmath_frontend$Page_TeacherDashboard$NoOp = {ctor: 'NoOp'};

var _shohamh$learnmath_frontend$Main$sessionChange = _shohamh$learnmath_frontend$Ports$onSessionChange(
	function (_p0) {
		return _elm_lang$core$Result$toMaybe(
			A2(_elm_lang$core$Json_Decode$decodeValue, _shohamh$learnmath_frontend$Data_User$decoder, _p0));
	});
var _shohamh$learnmath_frontend$Main$stylesheet = function () {
	var children = {ctor: '[]'};
	var attrs = {
		ctor: '::',
...
var _shohamh$learnmath_frontend$Main$getPage = function (pageState) {
	var _p1 = pageState;
	if (_p1.ctor === 'Loaded') {
		return _p1._0;
	} else {
...
var _shohamh$learnmath_frontend$Main$decodeUserFromJson = function (json) {
	return A2(
		_elm_lang$core$Maybe$andThen,
		function (_p2) {
			return _elm_lang$core$Result$toMaybe(
				A2(_elm_lang$core$Json_Decode$decodeString, _shohamh$learnmath_frontend$Data_User$decoder, _p2));
		},
		_elm_lang$core$Result$toMaybe(
			A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, json)));
};
var _shohamh$learnmath_frontend$Main$Model = F2(
	function (a, b) {
		return {pageState: a, session: b};
	});
var _shohamh$learnmath_frontend$Main$TeacherDashboard = function (a) {
	return {ctor: 'TeacherDashboard', _0: a};
};
var _shohamh$learnmath_frontend$Main$Dashboard = function (a) {
	return {ctor: 'Dashboard', _0: a};
};
var _shohamh$learnmath_frontend$Main$AddQuestion = function (a) {
	return {ctor: 'AddQuestion', _0: a};
};
var _shohamh$learnmath_frontend$Main$Question = function (a) {
	return {ctor: 'Question', _0: a};
};
var _shohamh$learnmath_frontend$Main$Register = function (a) {
	return {ctor: 'Register', _0: a};
};
var _shohamh$learnmath_frontend$Main$Login = function (a) {
	return {ctor: 'Login', _0: a};
};
var _shohamh$learnmath_frontend$Main$Home = function (a) {
	return {ctor: 'Home', _0: a};
};
var _shohamh$learnmath_frontend$Main$Errored = function (a) {
	return {ctor: 'Errored', _0: a};
};
var _shohamh$learnmath_frontend$Main$NotFound = {ctor: 'NotFound'};
var _shohamh$learnmath_frontend$Main$Blank = {ctor: 'Blank'};
var _shohamh$learnmath_frontend$Main$initialPage = _shohamh$learnmath_frontend$Main$Blank;
var _shohamh$learnmath_frontend$Main$HomeLoaded = function (a) {
	return {ctor: 'HomeLoaded', _0: a};
};
var _shohamh$learnmath_frontend$Main$SetRoute = function (a) {
	return {ctor: 'SetRoute', _0: a};
};
var _shohamh$learnmath_frontend$Main$SetUser = function (a) {
	return {ctor: 'SetUser', _0: a};
};
var _shohamh$learnmath_frontend$Main$TeacherDashboardMsg = function (a) {
	return {ctor: 'TeacherDashboardMsg', _0: a};
};
var _shohamh$learnmath_frontend$Main$DashboardMsg = function (a) {
	return {ctor: 'DashboardMsg', _0: a};
};
var _shohamh$learnmath_frontend$Main$AddQuestionMsg = function (a) {
	return {ctor: 'AddQuestionMsg', _0: a};
};
var _shohamh$learnmath_frontend$Main$QuestionMsg = function (a) {
	return {ctor: 'QuestionMsg', _0: a};
};
var _shohamh$learnmath_frontend$Main$pageSubscriptions = function (page) {
	var _p3 = page;
	switch (_p3.ctor) {
		case 'Blank':
			return _elm_lang$core$Platform_Sub$none;
		...
		case 'Question':
			return A2(
				...
				_shohamh$learnmath_frontend$Page_Question$subs(_p3._0));
		case 'AddQuestion':
			return _elm_lang$core$Platform_Sub$none;
		case 'Dashboard':
			return _elm_lang$core$Platform_Sub$none;
...
var _shohamh$learnmath_frontend$Main$subs = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _shohamh$learnmath_frontend$Main$pageSubscriptions(
				_shohamh$learnmath_frontend$Main$getPage(model.pageState)),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Sub$map, _shohamh$learnmath_frontend$Main$SetUser, _shohamh$learnmath_frontend$Main$sessionChange),
				_1: {ctor: '[]'}
			}
		});
};
var _shohamh$learnmath_frontend$Main$RegisterMsg = function (a) {
	return {ctor: 'RegisterMsg', _0: a};
};
var _shohamh$learnmath_frontend$Main$LoginMsg = function (a) {
	return {ctor: 'LoginMsg', _0: a};
};
var _shohamh$learnmath_frontend$Main$HomeMsg = function (a) {
	return {ctor: 'HomeMsg', _0: a};
};
var _shohamh$learnmath_frontend$Main$viewPage = F3(
	function (session, isLoading, page) {
		var frame = A2(_shohamh$learnmath_frontend$Views_Page$frame, isLoading, session.user);
		var _p4 = page;
		switch (_p4.ctor) {
			case 'NotFound':
				return A2(
					frame,
					_shohamh$learnmath_frontend$Views_Page$Other,
					_shohamh$learnmath_frontend$Page_NotFound$view(session));
			case 'Blank':
				return A2(
					frame,
					_shohamh$learnmath_frontend$Views_Page$Other,
			...
			case 'Errored':
				return A2(
					frame,
					_shohamh$learnmath_frontend$Views_Page$Other,
					A2(_shohamh$learnmath_frontend$Page_Errored$view, session, _p4._0));
			case 'Home':
				return A2(
					_elm_lang$html$Html$map,
					_shohamh$learnmath_frontend$Main$HomeMsg,
					A2(
						frame,
						_shohamh$learnmath_frontend$Views_Page$Home,
						A2(_shohamh$learnmath_frontend$Page_Home$view, session, _p4._0)));
			case 'Login':
				return A2(
					_elm_lang$html$Html$map,
					_shohamh$learnmath_frontend$Main$LoginMsg,
					A2(
						frame,
						_shohamh$learnmath_frontend$Views_Page$Other,
						A2(_shohamh$learnmath_frontend$Page_Login$view, session, _p4._0)));
			case 'Register':
				return A2(
					_elm_lang$html$Html$map,
					_shohamh$learnmath_frontend$Main$RegisterMsg,
					A2(
						frame,
						_shohamh$learnmath_frontend$Views_Page$Other,
						A2(_shohamh$learnmath_frontend$Page_Register$view, session, _p4._0)));
			case 'Question':
				return A2(
					_elm_lang$html$Html$map,
					_shohamh$learnmath_frontend$Main$QuestionMsg,
					A2(
						frame,
						_shohamh$learnmath_frontend$Views_Page$Other,
						A2(_shohamh$learnmath_frontend$Page_Question$view, session, _p4._0)));
			case 'AddQuestion':
				return A2(
					_elm_lang$html$Html$map,
					_shohamh$learnmath_frontend$Main$AddQuestionMsg,
					A2(
						frame,
						_shohamh$learnmath_frontend$Views_Page$Other,
						A2(_shohamh$learnmath_frontend$Page_AddQuestion$view, session, _p4._0)));
			case 'Dashboard':
				return A2(
					_elm_lang$html$Html$map,
					_shohamh$learnmath_frontend$Main$DashboardMsg,
					A2(
						frame,
						_shohamh$learnmath_frontend$Views_Page$Other,
						A2(_shohamh$learnmath_frontend$Page_Dashboard$view, session, _p4._0)));
			default:
				return A2(
					_elm_lang$html$Html$map,
					_shohamh$learnmath_frontend$Main$TeacherDashboardMsg,
					A2(
						frame,
						_shohamh$learnmath_frontend$Views_Page$Other,
						A2(_shohamh$learnmath_frontend$Page_TeacherDashboard$view, session, _p4._0)));
		}
	});
var _shohamh$learnmath_frontend$Main$view = function (model) {
	var _p5 = model.pageState;
	if (_p5.ctor === 'Loaded') {
		return A3(_shohamh$learnmath_frontend$Main$viewPage, model.session, false, _p5._0);
	} else {
		return A3(_shohamh$learnmath_frontend$Main$viewPage, model.session, true, _p5._0);
	}
};
var _shohamh$learnmath_frontend$Main$TransitioningFrom = function (a) {
	return {ctor: 'TransitioningFrom', _0: a};
};
var _shohamh$learnmath_frontend$Main$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _shohamh$learnmath_frontend$Main$pageErrored = F3(
	function (model, activePage, errorMessage) {
		var error = A2(_shohamh$learnmath_frontend$Page_Errored$pageLoadError, activePage, errorMessage);
		return A2(
			_shohamh$learnmath_frontend$Util_ops['=>'],
			_elm_lang$core$Native_Utils.update(
				model,
				{
					pageState: _shohamh$learnmath_frontend$Main$Loaded(
						_shohamh$learnmath_frontend$Main$Errored(error))
				}),
			_elm_lang$core$Platform_Cmd$none);
	});
var _shohamh$learnmath_frontend$Main$setRoute = F2(
	function (maybeRoute, model) {
		var errored = _shohamh$learnmath_frontend$Main$pageErrored(model);
		var transition = F2(
			function (toMsg, task) {
				return A2(
					_shohamh$learnmath_frontend$Util_ops['=>'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							pageState: _shohamh$learnmath_frontend$Main$TransitioningFrom(
								_shohamh$learnmath_frontend$Main$getPage(model.pageState))
						}),
		...
		if (_p6.ctor === 'Nothing') {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						pageState: _shohamh$learnmath_frontend$Main$Loaded(_shohamh$learnmath_frontend$Main$NotFound)
					}),
				_elm_lang$core$Platform_Cmd$none);
		} else {
			switch (_p6._0.ctor) {
				case 'Home':
					return A2(
						transition,
						_shohamh$learnmath_frontend$Main$HomeLoaded,
						_shohamh$learnmath_frontend$Page_Home$init(model.session));
				case 'Question':
					return A2(
						_shohamh$learnmath_frontend$Util_ops['=>'],
						_elm_lang$core$Native_Utils.update(
				...
				case 'AddQuestion':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _shohamh$learnmath_frontend$Main$Loaded(
									_shohamh$learnmath_frontend$Main$AddQuestion(_shohamh$learnmath_frontend$Page_AddQuestion$model))
							}),
						A2(
							_elm_lang$core$Platform_Cmd$map,
							_shohamh$learnmath_frontend$Main$AddQuestionMsg,
							A2(_shohamh$learnmath_frontend$Page_AddQuestion$loadCurriculumsAndSubjects, model.session, _shohamh$learnmath_frontend$Page_AddQuestion$model)));
				case 'Login':
					return A2(
						_shohamh$learnmath_frontend$Util_ops['=>'],
						_elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _shohamh$learnmath_frontend$Main$Loaded(
									_shohamh$learnmath_frontend$Main$Login(_shohamh$learnmath_frontend$Page_Login$model))
							}),
						_elm_lang$core$Platform_Cmd$none);
				case 'Logout':
					...
					return A2(
						...
						_elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _shohamh$learnmath_frontend$Ports$storeSession(_elm_lang$core$Maybe$Nothing),
								_1: {
									ctor: '::',
									_0: _shohamh$learnmath_frontend$Route$modifyUrl(_shohamh$learnmath_frontend$Route$Home),
									_1: {ctor: '[]'}
				...
				case 'Register':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _shohamh$learnmath_frontend$Main$Loaded(
									_shohamh$learnmath_frontend$Main$Register(_shohamh$learnmath_frontend$Page_Register$model))
							}),
						_elm_lang$core$Platform_Cmd$none);
				case 'Dashboard':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _shohamh$learnmath_frontend$Main$Loaded(
									_shohamh$learnmath_frontend$Main$Dashboard(_shohamh$learnmath_frontend$Page_Dashboard$model))
							}),
						_elm_lang$core$Platform_Cmd$none);
				default:
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _shohamh$learnmath_frontend$Main$Loaded(
									_shohamh$learnmath_frontend$Main$TeacherDashboard(_shohamh$learnmath_frontend$Page_TeacherDashboard$model))
							}),
						_elm_lang$core$Platform_Cmd$none);
			}
		}
	});
var _shohamh$learnmath_frontend$Main$init = F2(
	function (val, location) {
		var _p7 = A2(
			_shohamh$learnmath_frontend$Main$setRoute,
			_shohamh$learnmath_frontend$Route$fromLocation(location),
			{
				pageState: _shohamh$learnmath_frontend$Main$Loaded(_shohamh$learnmath_frontend$Main$initialPage),
				session: {
		...
		var model_ = _p7._0;
		var cmd_ = _p7._1;
		return {ctor: '_Tuple2', _0: model_, _1: cmd_};
	});
var _shohamh$learnmath_frontend$Main$updatePage = F3(
	function (page, msg, model) {
		...
		var session = model.session;
		var _p9 = {ctor: '_Tuple2', _0: msg, _1: page};
		_v5_10:
		do {
			_v5_9:
			do {
				switch (_p9._0.ctor) {
					case 'SetRoute':
						return A2(_shohamh$learnmath_frontend$Main$setRoute, _p9._0._0, model);
					case 'HomeLoaded':
						if (_p9._0._0.ctor === 'Ok') {
							return A2(
								_shohamh$learnmath_frontend$Util_ops['=>'],
								_elm_lang$core$Native_Utils.update(
									model,
									{
										pageState: _shohamh$learnmath_frontend$Main$Loaded(
											_shohamh$learnmath_frontend$Main$Home(_p9._0._0._0))
									}),
								_elm_lang$core$Platform_Cmd$none);
						} else {
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										pageState: _shohamh$learnmath_frontend$Main$Loaded(
											_shohamh$learnmath_frontend$Main$Errored(_p9._0._0._0))
									}),
								_elm_lang$core$Platform_Cmd$none);
						}
					case 'SetUser':
						var _p10 = _p9._0._0;
						var session = model.session;
						var cmd = ((!_elm_lang$core$Native_Utils.eq(session.user, _elm_lang$core$Maybe$Nothing)) && _elm_lang$core$Native_Utils.eq(_p10, _elm_lang$core$Maybe$Nothing)) ? _shohamh$learnmath_frontend$Route$modifyUrl(_shohamh$learnmath_frontend$Route$Home) : _elm_lang$core$Platform_Cmd$none;
						return A2(
							_shohamh$learnmath_frontend$Util_ops['=>'],
							_elm_lang$core$Native_Utils.update(
								model,
					...
					case 'LoginMsg':
						switch (_p9._1.ctor) {
							case 'Login':
								var _p11 = A2(_shohamh$learnmath_frontend$Page_Login$update, _p9._0._0, _p9._1._0);
								...
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										...
										{
											pageState: _shohamh$learnmath_frontend$Main$Loaded(
												_shohamh$learnmath_frontend$Main$Login(pageModel))
										}),
									A2(_elm_lang$core$Platform_Cmd$map, _shohamh$learnmath_frontend$Main$LoginMsg, cmd));
							case 'NotFound':
								break _v5_9;
							default:
								break _v5_10;
					...
					case 'RegisterMsg':
						switch (_p9._1.ctor) {
							case 'Register':
								var _p13 = A2(_shohamh$learnmath_frontend$Page_Register$update, _p9._0._0, _p9._1._0);
								var pageModel = _p13._0._0;
								var cmd = _p13._0._1;
								var msgFromPage = _p13._1;
								var newModel = function () {
								...
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										...
										{
											pageState: _shohamh$learnmath_frontend$Main$Loaded(
												_shohamh$learnmath_frontend$Main$Register(pageModel))
										}),
									A2(_elm_lang$core$Platform_Cmd$map, _shohamh$learnmath_frontend$Main$RegisterMsg, cmd));
							case 'NotFound':
								break _v5_9;
							default:
								break _v5_10;
					...
					case 'HomeMsg':
						switch (_p9._1.ctor) {
							case 'Home':
								return A5(
									toPage,
									_shohamh$learnmath_frontend$Main$Home,
									_shohamh$learnmath_frontend$Main$HomeMsg,
									_shohamh$learnmath_frontend$Page_Home$update(session),
									_p9._0._0,
									_p9._1._0);
							case 'NotFound':
								break _v5_9;
					...
					case 'QuestionMsg':
						switch (_p9._1.ctor) {
							case 'Question':
								return A5(
									toPage,
									_shohamh$learnmath_frontend$Main$Question,
									_shohamh$learnmath_frontend$Main$QuestionMsg,
									_shohamh$learnmath_frontend$Page_Question$update(session),
									_p9._0._0,
									_p9._1._0);
							case 'NotFound':
								break _v5_9;
					...
					case 'AddQuestionMsg':
						switch (_p9._1.ctor) {
							case 'AddQuestion':
								return A5(
									toPage,
									_shohamh$learnmath_frontend$Main$AddQuestion,
									_shohamh$learnmath_frontend$Main$AddQuestionMsg,
									_shohamh$learnmath_frontend$Page_AddQuestion$update(session),
									_p9._0._0,
									_p9._1._0);
							case 'NotFound':
								break _v5_9;
			...
			return A2(_shohamh$learnmath_frontend$Util_ops['=>'], model, _elm_lang$core$Platform_Cmd$none);
		} while(false);
		return A2(_shohamh$learnmath_frontend$Util_ops['=>'], model, _elm_lang$core$Platform_Cmd$none);
	});
var _shohamh$learnmath_frontend$Main$update = F2(
	function (msg, model) {
		return A3(
			_shohamh$learnmath_frontend$Main$updatePage,
			_shohamh$learnmath_frontend$Main$getPage(model.pageState),
			msg,
			model);
	});
var _shohamh$learnmath_frontend$Main$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	function (_p15) {
		return _shohamh$learnmath_frontend$Main$SetRoute(
			_shohamh$learnmath_frontend$Route$fromLocation(_p15));
	},
	{init: _shohamh$learnmath_frontend$Main$init, view: _shohamh$learnmath_frontend$Main$view, subscriptions: _shohamh$learnmath_frontend$Main$subs, update: _shohamh$learnmath_frontend$Main$update})(_elm_lang$core$Json_Decode$value);

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _shohamh$learnmath_frontend$Main$main !== 'undefined') {
    _shohamh$learnmath_frontend$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Data.User.Username":{"args":[],"tags":{"Username":["String"]}},"Page.AddQuestion.Msg":{"args":[],"tags":{"AddQuestion":[],"MyScriptExport":["String"],"SelectSubjects":["List String"],"SelectCurriculum":["String"],"LoadSubjectsInCurriculums":["Result.Result Http.Error Page.AddQuestion.SubjectsInCurriculums"],"AddQuestionResult":["Result.Result Http.Error Page.AddQuestion.ResponseData"]}},"Data.User.Role":{"args":[],"tags":{"Teacher":[],"Student":[]}},"Data.AuthToken.AuthToken":{"args":[],"tags":{"AuthToken":["String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Route.Route":{"args":[],"tags":{"AddQuestion":[],"Home":[],"Logout":[],"TeacherDashboard":[],"Register":[],"Dashboard":["Data.User.Username"],"Login":[],"Question":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Page.Dashboard.Msg":{"args":[],"tags":{"NoOp":[]}},"Main.Msg":{"args":[],"tags":{"QuestionMsg":["Page.Question.Msg"],"LoginMsg":["Page.Login.Msg"],"HomeLoaded":["Result.Result Page.Errored.PageLoadError Page.Home.Model"],"SetUser":["Maybe.Maybe Data.User.User"],"SetRoute":["Maybe.Maybe Route.Route"],"HomeMsg":["Page.Home.Msg"],"AddQuestionMsg":["Page.AddQuestion.Msg"],"TeacherDashboardMsg":["Page.TeacherDashboard.Msg"],"DashboardMsg":["Page.Dashboard.Msg"],"RegisterMsg":["Page.Register.Msg"]}},"Page.Question.Msg":{"args":[],"tags":{"MyScriptConvert":["String"],"CheckSolution":[],"MyScriptExport":["String"],"CheckSolutionResult":["Result.Result Http.Error Page.Question.CheckSolutionResponseData"],"LoadQuestionResult":["Result.Result Http.Error Page.Question.LoadQuestionResponseData"]}},"Page.Errored.PageLoadError":{"args":[],"tags":{"PageLoadError":["Page.Errored.Model"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Page.TeacherDashboard.Msg":{"args":[],"tags":{"NoOp":[]}},"Views.Page.ActivePage":{"args":[],"tags":{"Other":[],"AddQuestion":[],"Home":[],"TeacherDashboard":[],"Register":[],"Dashboard":["Data.User.Username"],"Login":[],"Question":[]}},"Page.Home.Msg":{"args":[],"tags":{"NoOp":[]}},"Page.Register.Msg":{"args":[],"tags":{"SetPasswordAgain":["String"],"RegisterResult":["Result.Result Http.Error Page.Register.ResponseData"],"Register":[],"SetUsername":["String"],"SetUserRole":["Data.User.Role"],"SetPassword":["String"],"SetEmail":["String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Page.Login.Msg":{"args":[],"tags":{"SetUsername":["String"],"Submit":[],"SubmitResult":["Result.Result Http.Error Page.Login.ResponseData"],"SetPassword":["String"]}}},"aliases":{"Page.AddQuestion.ResponseData":{"args":[],"type":"{ success : Bool, error_messages : List String }"},"Page.AddQuestion.SubjectsInCurriculums":{"args":[],"type":"{ subjectsInCurriculums : Dict.Dict String (List String) , success : Bool , error_messages : List String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Page.Errored.Model":{"args":[],"type":"{ activePage : Views.Page.ActivePage, errorMessage : String }"},"Page.Home.Model":{"args":[],"type":"{}"},"Page.Question.LoadQuestionResponseData":{"args":[],"type":"{ success : Bool , error_messages : List String , problem : String , subjects : List String }"},"Data.User.User":{"args":[],"type":"{ email : String , token : Data.AuthToken.AuthToken , username : Data.User.Username , role : Data.User.Role }"},"Page.Login.ResponseData":{"args":[],"type":"{ success : Bool , user : Data.User.User , error_messages : List String }"},"Page.Register.ResponseData":{"args":[],"type":"{ success : Bool, errorMessages : List String }"},"Page.Question.CheckSolutionResponseData":{"args":[],"type":"{ success : Bool, error_messages : List String, correct : Bool }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
